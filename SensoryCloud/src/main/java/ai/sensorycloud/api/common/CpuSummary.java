...
public  final class CpuSummary extends
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        ai.sensorycloud.api.common.CpuSummary, Builder> implements
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new ai.sensorycloud.api.common.CpuSummary();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<ai.sensorycloud.api.common.CpuSummary> parser = PARSER;
        if (parser == null) {
          synchronized (ai.sensorycloud.api.common.CpuSummary.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<ai.sensorycloud.api.common.CpuSummary>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
