...
public final class EventServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.sensory.api.v1.event.PublishUsageEventsRequest,
      io.sensory.api.v1.event.PublishUsageEventsResponse> getPublishUsageEventsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PublishUsageEvents",
      requestType = io.sensory.api.v1.event.PublishUsageEventsRequest.class,
      responseType = io.sensory.api.v1.event.PublishUsageEventsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.sensory.api.v1.event.PublishUsageEventsRequest,
      io.sensory.api.v1.event.PublishUsageEventsResponse> getPublishUsageEventsMethod() {
    io.grpc.MethodDescriptor<io.sensory.api.v1.event.PublishUsageEventsRequest, io.sensory.api.v1.event.PublishUsageEventsResponse> getPublishUsageEventsMethod;
      ...
      synchronized (EventServiceGrpc.class) {
        if ((getPublishUsageEventsMethod = EventServiceGrpc.getPublishUsageEventsMethod) == null) {
          EventServiceGrpc.getPublishUsageEventsMethod = getPublishUsageEventsMethod =
              io.grpc.MethodDescriptor.<io.sensory.api.v1.event.PublishUsageEventsRequest, io.sensory.api.v1.event.PublishUsageEventsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PublishUsageEvents"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.event.PublishUsageEventsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.event.PublishUsageEventsResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  public static abstract class EventServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void publishUsageEvents(io.sensory.api.v1.event.PublishUsageEventsRequest request,
        io.grpc.stub.StreamObserver<io.sensory.api.v1.event.PublishUsageEventsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.sensory.api.v1.event.PublishUsageEventsRequest,
                io.sensory.api.v1.event.PublishUsageEventsResponse>(
  ...
  public static final class EventServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<EventServiceBlockingStub> {
     ...
     * </pre>
     */
    public io.sensory.api.v1.event.PublishUsageEventsResponse publishUsageEvents(io.sensory.api.v1.event.PublishUsageEventsRequest request) {
  ...
  public static final class EventServiceFutureStub extends io.grpc.stub.AbstractFutureStub<EventServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.sensory.api.v1.event.PublishUsageEventsResponse> publishUsageEvents(
        io.sensory.api.v1.event.PublishUsageEventsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PUBLISH_USAGE_EVENTS:
          serviceImpl.publishUsageEvents((io.sensory.api.v1.event.PublishUsageEventsRequest) request,
              (io.grpc.stub.StreamObserver<io.sensory.api.v1.event.PublishUsageEventsResponse>) responseObserver);
          break;
        default:
