...
public final class AudioEventsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.sensory.api.v1.audio.ValidateEventRequest,
      io.sensory.api.v1.audio.ValidateEventResponse> getValidateEventMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ValidateEvent",
      requestType = io.sensory.api.v1.audio.ValidateEventRequest.class,
      responseType = io.sensory.api.v1.audio.ValidateEventResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.sensory.api.v1.audio.ValidateEventRequest,
      io.sensory.api.v1.audio.ValidateEventResponse> getValidateEventMethod() {
    io.grpc.MethodDescriptor<io.sensory.api.v1.audio.ValidateEventRequest, io.sensory.api.v1.audio.ValidateEventResponse> getValidateEventMethod;
      ...
      synchronized (AudioEventsGrpc.class) {
        if ((getValidateEventMethod = AudioEventsGrpc.getValidateEventMethod) == null) {
          AudioEventsGrpc.getValidateEventMethod = getValidateEventMethod =
              io.grpc.MethodDescriptor.<io.sensory.api.v1.audio.ValidateEventRequest, io.sensory.api.v1.audio.ValidateEventResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ValidateEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.ValidateEventRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.ValidateEventResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.sensory.api.v1.audio.CreateEnrolledEventRequest,
      io.sensory.api.v1.audio.CreateEnrollmentResponse> getCreateEnrolledEventMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateEnrolledEvent",
      requestType = io.sensory.api.v1.audio.CreateEnrolledEventRequest.class,
      responseType = io.sensory.api.v1.audio.CreateEnrollmentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.sensory.api.v1.audio.CreateEnrolledEventRequest,
      io.sensory.api.v1.audio.CreateEnrollmentResponse> getCreateEnrolledEventMethod() {
    io.grpc.MethodDescriptor<io.sensory.api.v1.audio.CreateEnrolledEventRequest, io.sensory.api.v1.audio.CreateEnrollmentResponse> getCreateEnrolledEventMethod;
      ...
      synchronized (AudioEventsGrpc.class) {
        if ((getCreateEnrolledEventMethod = AudioEventsGrpc.getCreateEnrolledEventMethod) == null) {
          AudioEventsGrpc.getCreateEnrolledEventMethod = getCreateEnrolledEventMethod =
              io.grpc.MethodDescriptor.<io.sensory.api.v1.audio.CreateEnrolledEventRequest, io.sensory.api.v1.audio.CreateEnrollmentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateEnrolledEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.CreateEnrolledEventRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.CreateEnrollmentResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.sensory.api.v1.audio.ValidateEnrolledEventRequest,
      io.sensory.api.v1.audio.ValidateEnrolledEventResponse> getValidateEnrolledEventMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ValidateEnrolledEvent",
      requestType = io.sensory.api.v1.audio.ValidateEnrolledEventRequest.class,
      responseType = io.sensory.api.v1.audio.ValidateEnrolledEventResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.sensory.api.v1.audio.ValidateEnrolledEventRequest,
      io.sensory.api.v1.audio.ValidateEnrolledEventResponse> getValidateEnrolledEventMethod() {
    io.grpc.MethodDescriptor<io.sensory.api.v1.audio.ValidateEnrolledEventRequest, io.sensory.api.v1.audio.ValidateEnrolledEventResponse> getValidateEnrolledEventMethod;
      ...
      synchronized (AudioEventsGrpc.class) {
        if ((getValidateEnrolledEventMethod = AudioEventsGrpc.getValidateEnrolledEventMethod) == null) {
          AudioEventsGrpc.getValidateEnrolledEventMethod = getValidateEnrolledEventMethod =
              io.grpc.MethodDescriptor.<io.sensory.api.v1.audio.ValidateEnrolledEventRequest, io.sensory.api.v1.audio.ValidateEnrolledEventResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ValidateEnrolledEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.ValidateEnrolledEventRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.ValidateEnrolledEventResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  public static abstract class AudioEventsImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.ValidateEventRequest> validateEvent(
        io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.ValidateEventResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.CreateEnrolledEventRequest> createEnrolledEvent(
        io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.CreateEnrollmentResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.ValidateEnrolledEventRequest> validateEnrolledEvent(
        io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.ValidateEnrolledEventResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                io.sensory.api.v1.audio.ValidateEventRequest,
                io.sensory.api.v1.audio.ValidateEventResponse>(
                  this, METHODID_VALIDATE_EVENT)))
          .addMethod(
            getCreateEnrolledEventMethod(),
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                io.sensory.api.v1.audio.CreateEnrolledEventRequest,
                io.sensory.api.v1.audio.CreateEnrollmentResponse>(
                  this, METHODID_CREATE_ENROLLED_EVENT)))
          .addMethod(
            getValidateEnrolledEventMethod(),
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                io.sensory.api.v1.audio.ValidateEnrolledEventRequest,
                io.sensory.api.v1.audio.ValidateEnrolledEventResponse>(
