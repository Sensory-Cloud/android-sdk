...
public final class AudioTranscriptionsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.sensory.api.v1.audio.TranscribeRequest,
      io.sensory.api.v1.audio.TranscribeResponse> getTranscribeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Transcribe",
      requestType = io.sensory.api.v1.audio.TranscribeRequest.class,
      responseType = io.sensory.api.v1.audio.TranscribeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.sensory.api.v1.audio.TranscribeRequest,
      io.sensory.api.v1.audio.TranscribeResponse> getTranscribeMethod() {
    io.grpc.MethodDescriptor<io.sensory.api.v1.audio.TranscribeRequest, io.sensory.api.v1.audio.TranscribeResponse> getTranscribeMethod;
      ...
      synchronized (AudioTranscriptionsGrpc.class) {
        if ((getTranscribeMethod = AudioTranscriptionsGrpc.getTranscribeMethod) == null) {
          AudioTranscriptionsGrpc.getTranscribeMethod = getTranscribeMethod =
              io.grpc.MethodDescriptor.<io.sensory.api.v1.audio.TranscribeRequest, io.sensory.api.v1.audio.TranscribeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Transcribe"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.TranscribeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.TranscribeResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  public static abstract class AudioTranscriptionsImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.TranscribeRequest> transcribe(
        io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.TranscribeResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                io.sensory.api.v1.audio.TranscribeRequest,
                io.sensory.api.v1.audio.TranscribeResponse>(
