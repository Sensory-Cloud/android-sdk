...
public  final class FileChunk extends
  ...
  public static io.sensory.api.v1.file.FileChunk parseFrom(
  ...
  public static io.sensory.api.v1.file.FileChunk parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static io.sensory.api.v1.file.FileChunk parseFrom(java.io.InputStream input)
  ...
  public static io.sensory.api.v1.file.FileChunk parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static io.sensory.api.v1.file.FileChunk parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(io.sensory.api.v1.file.FileChunk prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        io.sensory.api.v1.file.FileChunk, Builder> implements
      // @@protoc_insertion_point(builder_implements:sensory.api.v1.file.FileChunk)
      io.sensory.api.v1.file.FileChunkOrBuilder {
    // Construct using io.sensory.api.v1.file.FileChunk.newBuilder()
    private Builder() {
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new io.sensory.api.v1.file.FileChunk();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<io.sensory.api.v1.file.FileChunk> parser = PARSER;
        if (parser == null) {
          synchronized (io.sensory.api.v1.file.FileChunk.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<io.sensory.api.v1.file.FileChunk>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  private static final io.sensory.api.v1.file.FileChunk DEFAULT_INSTANCE;
  static {
  ...
  public static io.sensory.api.v1.file.FileChunk getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
