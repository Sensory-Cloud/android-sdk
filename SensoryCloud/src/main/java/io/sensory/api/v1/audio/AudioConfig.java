...
public  final class AudioConfig extends
   ...
   */
  @java.lang.Override
  public io.sensory.api.v1.audio.AudioConfig.AudioEncoding getEncoding() {
    io.sensory.api.v1.audio.AudioConfig.AudioEncoding result = io.sensory.api.v1.audio.AudioConfig.AudioEncoding.forNumber(encoding_);
    return result == null ? io.sensory.api.v1.audio.AudioConfig.AudioEncoding.UNRECOGNIZED : result;
  }
  /**
   * <pre>
   * Encoding of all sent audio data.
   ...
   */
  private void setEncoding(io.sensory.api.v1.audio.AudioConfig.AudioEncoding value) {
  ...
  public static io.sensory.api.v1.audio.AudioConfig parseFrom(
  ...
  public static io.sensory.api.v1.audio.AudioConfig parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static io.sensory.api.v1.audio.AudioConfig parseFrom(java.io.InputStream input)
  ...
  public static io.sensory.api.v1.audio.AudioConfig parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static io.sensory.api.v1.audio.AudioConfig parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(io.sensory.api.v1.audio.AudioConfig prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        io.sensory.api.v1.audio.AudioConfig, Builder> implements
      // @@protoc_insertion_point(builder_implements:sensory.api.v1.audio.AudioConfig)
      io.sensory.api.v1.audio.AudioConfigOrBuilder {
    // Construct using io.sensory.api.v1.audio.AudioConfig.newBuilder()
    private Builder() {
     ...
     * @return This builder for chaining.
     */
    public Builder setEncoding(io.sensory.api.v1.audio.AudioConfig.AudioEncoding value) {
      copyOnWrite();
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new io.sensory.api.v1.audio.AudioConfig();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<io.sensory.api.v1.audio.AudioConfig> parser = PARSER;
        if (parser == null) {
          synchronized (io.sensory.api.v1.audio.AudioConfig.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<io.sensory.api.v1.audio.AudioConfig>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  private static final io.sensory.api.v1.audio.AudioConfig DEFAULT_INSTANCE;
  static {
  ...
  public static io.sensory.api.v1.audio.AudioConfig getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
