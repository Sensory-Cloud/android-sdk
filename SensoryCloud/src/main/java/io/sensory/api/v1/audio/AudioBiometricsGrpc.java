...
public final class AudioBiometricsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.sensory.api.v1.audio.CreateEnrollmentRequest,
      io.sensory.api.v1.audio.CreateEnrollmentResponse> getCreateEnrollmentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateEnrollment",
      requestType = io.sensory.api.v1.audio.CreateEnrollmentRequest.class,
      responseType = io.sensory.api.v1.audio.CreateEnrollmentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.sensory.api.v1.audio.CreateEnrollmentRequest,
      io.sensory.api.v1.audio.CreateEnrollmentResponse> getCreateEnrollmentMethod() {
    io.grpc.MethodDescriptor<io.sensory.api.v1.audio.CreateEnrollmentRequest, io.sensory.api.v1.audio.CreateEnrollmentResponse> getCreateEnrollmentMethod;
      ...
      synchronized (AudioBiometricsGrpc.class) {
        if ((getCreateEnrollmentMethod = AudioBiometricsGrpc.getCreateEnrollmentMethod) == null) {
          AudioBiometricsGrpc.getCreateEnrollmentMethod = getCreateEnrollmentMethod =
              io.grpc.MethodDescriptor.<io.sensory.api.v1.audio.CreateEnrollmentRequest, io.sensory.api.v1.audio.CreateEnrollmentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateEnrollment"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.CreateEnrollmentRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.sensory.api.v1.audio.AuthenticateRequest,
      io.sensory.api.v1.audio.AuthenticateResponse> getAuthenticateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Authenticate",
      requestType = io.sensory.api.v1.audio.AuthenticateRequest.class,
      responseType = io.sensory.api.v1.audio.AuthenticateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.sensory.api.v1.audio.AuthenticateRequest,
      io.sensory.api.v1.audio.AuthenticateResponse> getAuthenticateMethod() {
    io.grpc.MethodDescriptor<io.sensory.api.v1.audio.AuthenticateRequest, io.sensory.api.v1.audio.AuthenticateResponse> getAuthenticateMethod;
      ...
      synchronized (AudioBiometricsGrpc.class) {
        if ((getAuthenticateMethod = AudioBiometricsGrpc.getAuthenticateMethod) == null) {
          AudioBiometricsGrpc.getAuthenticateMethod = getAuthenticateMethod =
              io.grpc.MethodDescriptor.<io.sensory.api.v1.audio.AuthenticateRequest, io.sensory.api.v1.audio.AuthenticateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Authenticate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.AuthenticateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.AuthenticateResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  public static abstract class AudioBiometricsImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.CreateEnrollmentRequest> createEnrollment(
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.AuthenticateRequest> authenticate(
        io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.AuthenticateResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                io.sensory.api.v1.audio.CreateEnrollmentRequest,
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                io.sensory.api.v1.audio.AuthenticateRequest,
                io.sensory.api.v1.audio.AuthenticateResponse>(
