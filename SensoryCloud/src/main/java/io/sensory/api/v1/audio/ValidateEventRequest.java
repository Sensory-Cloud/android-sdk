...
public  final class ValidateEventRequest extends
    com.google.protobuf.GeneratedMessageLite<
        ValidateEventRequest, ValidateEventRequest.Builder> implements
   ...
   */
  @java.lang.Override
  public io.sensory.api.v1.audio.ValidateEventConfig getConfig() {
    if (streamingRequestCase_ == 1) {
       return (io.sensory.api.v1.audio.ValidateEventConfig) streamingRequest_;
    }
    return io.sensory.api.v1.audio.ValidateEventConfig.getDefaultInstance();
  }
  /**
   * <pre>
   * Provides information that specifies how to process the
   ...
   * <code>.sensory.api.v1.audio.ValidateEventConfig config = 1;</code>
   */
  private void setConfig(io.sensory.api.v1.audio.ValidateEventConfig value) {
    value.getClass();
   ...
   * <code>.sensory.api.v1.audio.ValidateEventConfig config = 1;</code>
   */
  private void mergeConfig(io.sensory.api.v1.audio.ValidateEventConfig value) {
    value.getClass();
  if (streamingRequestCase_ == 1 &&
        streamingRequest_ != io.sensory.api.v1.audio.ValidateEventConfig.getDefaultInstance()) {
      streamingRequest_ = io.sensory.api.v1.audio.ValidateEventConfig.newBuilder((io.sensory.api.v1.audio.ValidateEventConfig) streamingRequest_)
  ...
  public static io.sensory.api.v1.audio.ValidateEventRequest parseFrom(
  ...
  public static io.sensory.api.v1.audio.ValidateEventRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static io.sensory.api.v1.audio.ValidateEventRequest parseFrom(java.io.InputStream input)
  ...
  public static io.sensory.api.v1.audio.ValidateEventRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static io.sensory.api.v1.audio.ValidateEventRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(io.sensory.api.v1.audio.ValidateEventRequest prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        io.sensory.api.v1.audio.ValidateEventRequest, Builder> implements
      // @@protoc_insertion_point(builder_implements:sensory.api.v1.audio.ValidateEventRequest)
      io.sensory.api.v1.audio.ValidateEventRequestOrBuilder {
    // Construct using io.sensory.api.v1.audio.ValidateEventRequest.newBuilder()
    private Builder() {
     ...
     * <code>.sensory.api.v1.audio.ValidateEventConfig config = 1;</code>
     */
    public Builder setConfig(io.sensory.api.v1.audio.ValidateEventConfig value) {
      copyOnWrite();
    ...
    public Builder setConfig(
        io.sensory.api.v1.audio.ValidateEventConfig.Builder builderForValue) {
      copyOnWrite();
     ...
     * <code>.sensory.api.v1.audio.ValidateEventConfig config = 1;</code>
     */
    public Builder mergeConfig(io.sensory.api.v1.audio.ValidateEventConfig value) {
      copyOnWrite();
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new io.sensory.api.v1.audio.ValidateEventRequest();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      case BUILD_MESSAGE_INFO: {
          java.lang.Object[] objects = new java.lang.Object[] {
            "streamingRequest_",
            "streamingRequestCase_",
            io.sensory.api.v1.audio.ValidateEventConfig.class,
            "postProcessingAction_",
          };
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<io.sensory.api.v1.audio.ValidateEventRequest> parser = PARSER;
        if (parser == null) {
          synchronized (io.sensory.api.v1.audio.ValidateEventRequest.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<io.sensory.api.v1.audio.ValidateEventRequest>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  private static final io.sensory.api.v1.audio.ValidateEventRequest DEFAULT_INSTANCE;
  static {
    ValidateEventRequest defaultInstance = new ValidateEventRequest();
    // New instances are implicitly immutable so no need to make
    // immutable.
    DEFAULT_INSTANCE = defaultInstance;
    com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
      ValidateEventRequest.class, defaultInstance);
  }

  public static io.sensory.api.v1.audio.ValidateEventRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static volatile com.google.protobuf.Parser<ValidateEventRequest> PARSER;
