...
public final class VideoBiometricsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.sensory.api.v1.video.CreateEnrollmentRequest,
      io.sensory.api.v1.video.CreateEnrollmentResponse> getCreateEnrollmentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateEnrollment",
      requestType = io.sensory.api.v1.video.CreateEnrollmentRequest.class,
      responseType = io.sensory.api.v1.video.CreateEnrollmentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.sensory.api.v1.video.CreateEnrollmentRequest,
      io.sensory.api.v1.video.CreateEnrollmentResponse> getCreateEnrollmentMethod() {
    io.grpc.MethodDescriptor<io.sensory.api.v1.video.CreateEnrollmentRequest, io.sensory.api.v1.video.CreateEnrollmentResponse> getCreateEnrollmentMethod;
      ...
      synchronized (VideoBiometricsGrpc.class) {
        if ((getCreateEnrollmentMethod = VideoBiometricsGrpc.getCreateEnrollmentMethod) == null) {
          VideoBiometricsGrpc.getCreateEnrollmentMethod = getCreateEnrollmentMethod =
              io.grpc.MethodDescriptor.<io.sensory.api.v1.video.CreateEnrollmentRequest, io.sensory.api.v1.video.CreateEnrollmentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateEnrollment"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.video.CreateEnrollmentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.video.CreateEnrollmentResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.sensory.api.v1.video.AuthenticateRequest,
      io.sensory.api.v1.video.AuthenticateResponse> getAuthenticateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Authenticate",
      requestType = io.sensory.api.v1.video.AuthenticateRequest.class,
      responseType = io.sensory.api.v1.video.AuthenticateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.sensory.api.v1.video.AuthenticateRequest,
      io.sensory.api.v1.video.AuthenticateResponse> getAuthenticateMethod() {
    io.grpc.MethodDescriptor<io.sensory.api.v1.video.AuthenticateRequest, io.sensory.api.v1.video.AuthenticateResponse> getAuthenticateMethod;
      ...
      synchronized (VideoBiometricsGrpc.class) {
        if ((getAuthenticateMethod = VideoBiometricsGrpc.getAuthenticateMethod) == null) {
          VideoBiometricsGrpc.getAuthenticateMethod = getAuthenticateMethod =
              io.grpc.MethodDescriptor.<io.sensory.api.v1.video.AuthenticateRequest, io.sensory.api.v1.video.AuthenticateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Authenticate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.video.AuthenticateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.video.AuthenticateResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  public static abstract class VideoBiometricsImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.sensory.api.v1.video.CreateEnrollmentRequest> createEnrollment(
        io.grpc.stub.StreamObserver<io.sensory.api.v1.video.CreateEnrollmentResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.sensory.api.v1.video.AuthenticateRequest> authenticate(
        io.grpc.stub.StreamObserver<io.sensory.api.v1.video.AuthenticateResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                io.sensory.api.v1.video.CreateEnrollmentRequest,
                io.sensory.api.v1.video.CreateEnrollmentResponse>(
                  this, METHODID_CREATE_ENROLLMENT)))
          .addMethod(
            getAuthenticateMethod(),
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                io.sensory.api.v1.video.AuthenticateRequest,
                io.sensory.api.v1.video.AuthenticateResponse>(
