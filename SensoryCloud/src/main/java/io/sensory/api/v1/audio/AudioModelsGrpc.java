...
public final class AudioModelsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.sensory.api.v1.audio.GetModelsRequest,
      io.sensory.api.v1.audio.GetModelsResponse> getGetModelsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetModels",
      requestType = io.sensory.api.v1.audio.GetModelsRequest.class,
      responseType = io.sensory.api.v1.audio.GetModelsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.sensory.api.v1.audio.GetModelsRequest,
      io.sensory.api.v1.audio.GetModelsResponse> getGetModelsMethod() {
    io.grpc.MethodDescriptor<io.sensory.api.v1.audio.GetModelsRequest, io.sensory.api.v1.audio.GetModelsResponse> getGetModelsMethod;
      ...
      synchronized (AudioModelsGrpc.class) {
        if ((getGetModelsMethod = AudioModelsGrpc.getGetModelsMethod) == null) {
          AudioModelsGrpc.getGetModelsMethod = getGetModelsMethod =
              io.grpc.MethodDescriptor.<io.sensory.api.v1.audio.GetModelsRequest, io.sensory.api.v1.audio.GetModelsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetModels"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.GetModelsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.v1.audio.GetModelsResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  public static abstract class AudioModelsImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getModels(io.sensory.api.v1.audio.GetModelsRequest request,
        io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.GetModelsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.sensory.api.v1.audio.GetModelsRequest,
                io.sensory.api.v1.audio.GetModelsResponse>(
  ...
  public static final class AudioModelsBlockingStub extends io.grpc.stub.AbstractBlockingStub<AudioModelsBlockingStub> {
     ...
     * </pre>
     */
    public io.sensory.api.v1.audio.GetModelsResponse getModels(io.sensory.api.v1.audio.GetModelsRequest request) {
  ...
  public static final class AudioModelsFutureStub extends io.grpc.stub.AbstractFutureStub<AudioModelsFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.sensory.api.v1.audio.GetModelsResponse> getModels(
        io.sensory.api.v1.audio.GetModelsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MODELS:
          serviceImpl.getModels((io.sensory.api.v1.audio.GetModelsRequest) request,
              (io.grpc.stub.StreamObserver<io.sensory.api.v1.audio.GetModelsResponse>) responseObserver);
          break;
        default:
