...
public  final class CompressionConfiguration extends
  ...
  private static final com.google.protobuf.Internal.ListAdapter.Converter<
      java.lang.Integer, io.sensory.api.common.CompressionType> compressions_converter_ =
          new com.google.protobuf.Internal.ListAdapter.Converter<
              java.lang.Integer, io.sensory.api.common.CompressionType>() {
            @java.lang.Override
            public io.sensory.api.common.CompressionType convert(java.lang.Integer from) {
              io.sensory.api.common.CompressionType result = io.sensory.api.common.CompressionType.forNumber(from);
              return result == null ? io.sensory.api.common.CompressionType.UNRECOGNIZED : result;
            }
          };
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<io.sensory.api.common.CompressionType> getCompressionsList() {
    return new com.google.protobuf.Internal.ListAdapter<
        java.lang.Integer, io.sensory.api.common.CompressionType>(compressions_, compressions_converter_);
  }
  /**
   * <pre>
   * List of every compression method that was used
   ...
   */
  @java.lang.Override
  public io.sensory.api.common.CompressionType getCompressions(int index) {
  ...
  private void setCompressions(
      int index, io.sensory.api.common.CompressionType value) {
    value.getClass();
   ...
   */
  private void addCompressions(io.sensory.api.common.CompressionType value) {
    value.getClass();
  ensureCompressionsIsMutable();
  ...
  private void addAllCompressions(
      java.lang.Iterable<? extends io.sensory.api.common.CompressionType> values) {
    ensureCompressionsIsMutable();
    for (io.sensory.api.common.CompressionType value : values) {
      compressions_.addInt(value.getNumber());
    }
  }
  /**
  ...
  public static io.sensory.api.common.CompressionConfiguration parseFrom(
  ...
  public static io.sensory.api.common.CompressionConfiguration parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static io.sensory.api.common.CompressionConfiguration parseFrom(java.io.InputStream input)
  ...
  public static io.sensory.api.common.CompressionConfiguration parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static io.sensory.api.common.CompressionConfiguration parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(io.sensory.api.common.CompressionConfiguration prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        io.sensory.api.common.CompressionConfiguration, Builder> implements
      // @@protoc_insertion_point(builder_implements:sensory.api.common.CompressionConfiguration)
      io.sensory.api.common.CompressionConfigurationOrBuilder {
    // Construct using io.sensory.api.common.CompressionConfiguration.newBuilder()
    private Builder() {
     ...
     * @return This builder for chaining.
     */
    public Builder addCompressions(io.sensory.api.common.CompressionType value) {
      copyOnWrite();
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new io.sensory.api.common.CompressionConfiguration();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<io.sensory.api.common.CompressionConfiguration> parser = PARSER;
        if (parser == null) {
          synchronized (io.sensory.api.common.CompressionConfiguration.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<io.sensory.api.common.CompressionConfiguration>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  private static final io.sensory.api.common.CompressionConfiguration DEFAULT_INSTANCE;
  static {
  ...
  public static io.sensory.api.common.CompressionConfiguration getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
