...
public final class HealthServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.sensory.api.health.HealthRequest,
      io.sensory.api.common.ServerHealthResponse> getGetHealthMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetHealth",
      requestType = io.sensory.api.health.HealthRequest.class,
      responseType = io.sensory.api.common.ServerHealthResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.sensory.api.health.HealthRequest,
      io.sensory.api.common.ServerHealthResponse> getGetHealthMethod() {
    io.grpc.MethodDescriptor<io.sensory.api.health.HealthRequest, io.sensory.api.common.ServerHealthResponse> getGetHealthMethod;
      ...
      synchronized (HealthServiceGrpc.class) {
        if ((getGetHealthMethod = HealthServiceGrpc.getGetHealthMethod) == null) {
          HealthServiceGrpc.getGetHealthMethod = getGetHealthMethod =
              io.grpc.MethodDescriptor.<io.sensory.api.health.HealthRequest, io.sensory.api.common.ServerHealthResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetHealth"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.health.HealthRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  io.sensory.api.common.ServerHealthResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  public static abstract class HealthServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getHealth(io.sensory.api.health.HealthRequest request,
        io.grpc.stub.StreamObserver<io.sensory.api.common.ServerHealthResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.sensory.api.health.HealthRequest,
                io.sensory.api.common.ServerHealthResponse>(
  ...
  public static final class HealthServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HealthServiceBlockingStub> {
     ...
     * </pre>
     */
    public io.sensory.api.common.ServerHealthResponse getHealth(io.sensory.api.health.HealthRequest request) {
  ...
  public static final class HealthServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HealthServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.sensory.api.common.ServerHealthResponse> getHealth(
        io.sensory.api.health.HealthRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_HEALTH:
          serviceImpl.getHealth((io.sensory.api.health.HealthRequest) request,
              (io.grpc.stub.StreamObserver<io.sensory.api.common.ServerHealthResponse>) responseObserver);
          break;
        default:
