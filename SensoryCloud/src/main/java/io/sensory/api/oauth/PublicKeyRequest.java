...
public  final class PublicKeyRequest extends
  ...
  public static io.sensory.api.oauth.PublicKeyRequest parseFrom(
  ...
  public static io.sensory.api.oauth.PublicKeyRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static io.sensory.api.oauth.PublicKeyRequest parseFrom(java.io.InputStream input)
  ...
  public static io.sensory.api.oauth.PublicKeyRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static io.sensory.api.oauth.PublicKeyRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(io.sensory.api.oauth.PublicKeyRequest prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        io.sensory.api.oauth.PublicKeyRequest, Builder> implements
      // @@protoc_insertion_point(builder_implements:sensory.api.oauth.PublicKeyRequest)
      io.sensory.api.oauth.PublicKeyRequestOrBuilder {
    // Construct using io.sensory.api.oauth.PublicKeyRequest.newBuilder()
    private Builder() {
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new io.sensory.api.oauth.PublicKeyRequest();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<io.sensory.api.oauth.PublicKeyRequest> parser = PARSER;
        if (parser == null) {
          synchronized (io.sensory.api.oauth.PublicKeyRequest.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<io.sensory.api.oauth.PublicKeyRequest>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  private static final io.sensory.api.oauth.PublicKeyRequest DEFAULT_INSTANCE;
  static {
  ...
  public static io.sensory.api.oauth.PublicKeyRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
